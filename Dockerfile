...
# essential php libs
RUN apk add openssl openssl-dev php-openssl php-pdo php-pdo_mysql php-curl php-gd php-mcrypt php-iconv php-mysql php-mysqli php-json php-xml php-ctype php-xsl ssmtp
